...
export const metadata = {
  ...
  description: "Conoce un poco más de la empresa y de nuestros servicios.",
  icons: {
    icon: "/favicon.ico",
  },
};
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            Somos una empresa enfocada en soluciones tecnológicas eficientes. Ya
            sea programación, diseño, redes o mantenimiento, nuestro equipo está
            listo para ayudarte a llevar tu proyecto al siguiente nivel.
          </p>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700 text-sm">
                Instalación y mantenimiento de redes, punto a punto y cableado.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all">
              ...
              <h3 className="text-xl font-bold mb-2">Proyectos de Software</h3>
              <p className="text-gray-700 text-sm">
                Desarrollo de sistemas de venta, páginas web, cotizadores y más.
              </p>
            </div>
          </div>
        </div>
